...
public class BooksForm extends JFrame {
    ...
    private JTextField textField_5; // Added JTextField for Book ID
    ...
    public BooksForm() {
        ...
        btnAddBooks.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String bookId = textField_5.getText();
                ...
                int i = BookDao.save(bookId, callno, name, author, publisher, quantity);
                if (i > 0) {
                                ...
                                .addGroup(gl_contentPane.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(gl_contentPane.createSequentialGroup()
                                                ...
                                                .addGroup(gl_contentPane.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                                        ...
                                                        .addComponent(lblBookId, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                                .addGap(47)
                                                .addGroup(gl_contentPane.createParallelGroup(GroupLayout.Alignment.LEADING)
