    ...
    public IssueBookForm() {
        ...
        btnIssueBook.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String studentIdText = textField_2.getText();
                ...
                try {
                    ...
                    if (IssueBookDao.checkBook(bookcallno)) {
                        int i = IssueBookDao.save(bookcallno, studentid, studentname, studentcontact, id);
                        if (i > 0) {
                    ...
                    JOptionPane.showMessageDialog(IssueBookForm.this, "Invalid input for Student ID or ID. Please enter numeric values.");
                }
            }
        });
                                ...
                                .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                        .addGroup(gl_contentPane.createSequentialGroup()
                                                ...
                                                .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                                        ...
                                                        .addComponent(textFieldId, GroupLayout.PREFERRED_SIZE, 172, GroupLayout.PREFERRED_SIZE))
                                                .addGap(48))
