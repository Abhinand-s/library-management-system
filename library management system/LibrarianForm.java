...
public class LibrarianForm extends JFrame {
    ...
    private JTextField textFieldId; // Added JTextField for ID
    ...
    public LibrarianForm() {
        ...
        JLabel lblId = new JLabel("ID:"); // Added JLabel for ID
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String id = textFieldId.getText(); // Retrieve the ID
                ...
                int i = LibrarianDao.save(id, name, password, email, address, city, contact);
                if (i > 0) {
